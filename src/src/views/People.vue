...
#info-card {
    ...
    height: 43.42vw;
    background:
      linear-gradient(217deg, rgba(245, 251, 255, 0.8), rgba(245, 251, 255, 0) 80%),
      linear-gradient(127deg, rgba(226, 226, 226, 0.8), rgba(226, 226, 226, 0) 80%),
      linear-gradient(336deg, rgba(215, 231, 255, 0.8), rgba(215, 231, 255, 0) 80%);
}
#friend-info-card {
    display: inline-block;
    width: 75vw;
